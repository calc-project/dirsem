---
title: "Directionl tendencies in semantic change"
...
Restructuring Winter-Overt-Marking data in a dataframe
```{r}
...
Restructuring Urban-Indo-Aryan data in a dataframe
```{r}
...
Restructuring List-Partial-Colexifications data in a dataframe
```{r}
...
Restructuring Zalizniak-DatsemShift data in a dataframe
```{r}
...
Winter-Overt-Marking and Urban-Indo-Aryan
```{r}
...
List-Partial-Colexifications and Urban-Indo-Aryan
```{r}
...
List-Partial-Colexifications and Zalizniak-Polysemy
```{r}
